          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center gap-3">
              <a 
                ...
                className="p-1.5 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-[#1DA1F2] hover:text-white transition-all"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-1.5 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-[#4267B2] hover:text-white transition-all"
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="p-1.5 rounded-full bg-neutral-200 dark:bg-neutral-800 text-neutral-700 dark:text-neutral-300 hover:bg-[#0077b5] hover:text-white transition-all"
