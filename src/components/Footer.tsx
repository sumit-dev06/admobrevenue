...
export const Footer = React.memo(() => {
  ...
  return (
    <footer className="border-t border-dashed border-neutral-300 dark:border-neutral-800 bg-neutral-50 dark:bg-neutral-950 py-8 transition-colors text-xs font-mono mt-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-4">
          
          <div className="flex flex-wrap justify-center items-center gap-4 text-neutral-500">
            <a href="/?page=admob" className="hover:text-neutral-900 dark:hover:text-white transition-colors">AdMob Calculator</a>
            <span className="hidden sm:inline">·</span>
            <a href="/?page=adsense" className="hover:text-neutral-900 dark:hover:text-white transition-colors">AdSense Calculator</a>
            <span className="hidden sm:inline">·</span>
            <a href="#comprehensive-guide" className="hover:text-neutral-900 dark:hover:text-white transition-colors">Optimization Guide</a>
            <span className="hidden sm:inline">·</span>
            <a href="#faq-section" className="hover:text-neutral-900 dark:hover:text-white transition-colors">FAQ</a>
          </div>

          <div className="flex items-center gap-3">
            <span className="text-neutral-500 mr-2">Share:</span>
            <a 
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-3 text-neutral-500 pt-4 border-t border-dashed border-neutral-200 dark:border-neutral-800">
          <div>
