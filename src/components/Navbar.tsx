    ...
    <header className="sticky top-0 z-50 w-full border-b border-dashed border-neutral-300 dark:border-neutral-800 bg-white/95 dark:bg-neutral-950/95 backdrop-blur-md transition-colors overflow-x-hidden">
      <div className="max-w-6xl mx-auto px-3 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-13 sm:h-14 gap-2">
          ...
          <nav className="flex items-center gap-1 border border-dashed border-neutral-300 dark:border-neutral-800 p-0.5 sm:p-1 rounded-xl bg-neutral-50 dark:bg-neutral-900/60 text-xs font-mono shrink min-w-0">
            <button
              onClick={() => onPlatformChange("admob")}
              className={
          ...
          <div className="flex items-center gap-1 sm:gap-2 shrink-0">
            ...
            <button
              ...
              className="hidden lg:flex items-center gap-1 px-2.5 py-1 text-xs font-mono font-semibold text-white bg-neutral-900 dark:bg-neutral-100 dark:text-neutral-950 border border-dashed border-neutral-700 dark:border-neutral-300 rounded-lg hover:bg-neutral-800 dark:hover:bg-white transition-all"
            >
