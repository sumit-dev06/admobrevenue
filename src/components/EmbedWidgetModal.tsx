        ...
        <div className="grid grid-cols-2 gap-3">
          <div>
            ...
            <select
              ...
              className="w-full bg-neutral-50 dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 text-xs font-semibold rounded-xl px-3 py-2 text-neutral-900 dark:text-white"
            >
